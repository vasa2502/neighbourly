...
import { ArrowRight, CheckCircle2, Calendar, MapPin, Users } from "lucide-react";
...
export default function ActivityJoinConfirmation() {
  ...
  // Always show confirmation — use real data when available, fallback otherwise
    ...
    <div className="max-w-lg mx-auto px-4 pb-24 lg:pb-8 pt-12">
      <Reveal>
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-[Bricolage_Grotesque] font-extrabold text-foreground mb-2">You&apos;re in!</h1>
